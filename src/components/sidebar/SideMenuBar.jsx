...
export default function SideMenuBar({ collapsed, toggleMenu, menus, overlay, closeMenu }) {
    ...
    return (
        <div className={sidebarClass}>
            <div className={`${style.sidebar_inner} sidebar_inner`}>
                <div className={`${style.menu_btn} menu_btn`} onClick={() => toggleMenu()}>
                    <span className="icon-menu_btn"></span>
                </div>
                <div className={`${style.mobile_close} mobile_close`} onClick={() => closeMenu()}>
                    <span className="icon-menu_btn"></span>
                </div>
                <div className={style.sidebar_content_wrapper}>
                    <nav>
                        <ul className={`${style.sidebar_link_list} sidebar_link_list`}>
                            {menus && menus.map((item, index) => (<SideMenubarItem key={index} item={item} />))}
                    ...
                    <SidebarCarousel />
                    {/* <div className={style.menu_bg_image}></div> */}
                </div>
            </div>
        </div>
    )
